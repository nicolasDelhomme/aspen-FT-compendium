---
title: "Aspen Differential Expression - year around - Effect of location in Dec, Jan, Feb vs CTW8/10 in young trees"
...
ext.location.summer <- "In_Out_DecFeb_CTW8_10_young"
...
data.long <- data %>%
  ...
  mutate(Treatment = if_else(S1 == "T89" & S2 == "CTW10", "CTW10",
                       if_else(S1 == "CTW10", "CTW10",    
              if_else(S1 == "T89" & S2 == "CTW8", "CTW8",
                      if_else(S1 == "JAN", "JAN",
                              if_else(S1 == "FEB", "FEB", 
                                      if_else(S1 == "DEC", "DEC", "0")))))))
